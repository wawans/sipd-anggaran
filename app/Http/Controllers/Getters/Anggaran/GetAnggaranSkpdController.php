...
use App\Jobs\Getters\Anggaran\GetAnggaranSkpdJob;
use App\Models\Getters\Anggaran\GetAnggaranSkpd;
use App\Repositories\Getters\Anggaran\GetAnggaranSkpdRepository;
use Illuminate\Http\Request;

class GetAnggaranSkpdController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        dispatch(new GetAnggaranSkpdJob($validated['data']));
