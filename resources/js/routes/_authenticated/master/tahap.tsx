...
import { columns } from '@/pages/getters/columns/master/tahap-columns'
import { dataTableQueryOptions } from '@/pages/getters/components/data-table-provider'
import Page from '@/pages/getters/index'

const URL: string = '/api/master/tahap'

export const Route = createFileRoute('/_authenticated/master/tahap')({
