...
use App\Jobs\Getters\Anggaran\GetAnggaranBelanjaSubKetJob;
...
class GetAnggaranBelanjaSubKetController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        defer(fn () => dispatch(new GetAnggaranBelanjaSubKetJob($validated['data'] ?? [])));
