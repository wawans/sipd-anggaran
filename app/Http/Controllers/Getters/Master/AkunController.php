...
use App\Jobs\Master\AkunJob;
use App\Models\Getters\Master\Akun;
use App\Repositories\Getters\Master\AkunRepository;
...
class AkunController extends Controller implements HasMiddleware
{
    use WithExportImport;

    public function __construct(protected AkunRepository $repository) {}
    ...
    public function store(Request $request)
    {
        ...
        dispatch(new AkunJob($validated['data']));
    ...
    {
        // $model = $this->repository->toArray($akun);
    ...
    {
        // $model = $this->repository->edit($request->validated(), $akun);
        // return ApiResponse::data($model);
    }
