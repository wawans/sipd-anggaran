...
// use App\Repositories\DanaRepository;
...
class DanaController extends Controller implements HasMiddleware
{
    ...
    public function __construct(protected DanaRepository $repository) {}
    ...
    public function store(Request $request)
    {
        ...
        dispatch(new DanaJob($validated['data']));
    ...
    {
        // $model = $this->repository->toArray($dana);
    ...
    {
        // $model = $this->repository->edit($request->validated(), $dana);
        // return ApiResponse::data($model);
    }
