...
/**
 * \App\Repositories\Getters\Master\DanaRepository
 *
 * @property Dana $model
 *
...
class DanaRepository extends Repository
{
     ...
     */
    public function __construct(protected Dana $model) {}
     ...
     * @return Dana
     */
    public function edit($attributes, Dana $dana)
    {
        return $this->update($attributes, $dana);
    }
