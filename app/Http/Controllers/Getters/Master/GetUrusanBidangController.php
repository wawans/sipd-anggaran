...
class GetUrusanBidangController extends Controller implements HasMiddleware
{
    use WithExportImport;

    public function __construct(protected GetUrusanBidangRepository $repository) {}
    ...
    public function store(Request $request)
    {
        ...
        dispatch(new GetUrusanBidangJob($validated['data']));
     ...
     */
    public function show(GetUrusanBidang $getUrusanBidang)
    {
        // $model = $this->repository->toArray($getUrusanBidang);
     ...
     */
    public function update(Request $request, GetUrusanBidang $getUrusanBidang)
    {
        // $model = $this->repository->edit($request->validated(), $getUrusanBidang);
        // return ApiResponse::data($model);
    }
    ...
    {
        // $this->repository->destroy($getUrusanBidang);
        // return ApiResponse::data();
    }
