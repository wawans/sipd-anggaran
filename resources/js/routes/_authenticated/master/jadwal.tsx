...
import { columns } from '@/pages/getters/columns/master/jadwal-columns'
import { dataTableQueryOptions } from '@/pages/getters/components/data-table-provider'
import Page from '@/pages/getters/index'

const URL: string = '/api/master/jadwal'

export const Route = createFileRoute('/_authenticated/master/jadwal')({
