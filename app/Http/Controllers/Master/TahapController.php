...
use App\Jobs\Master\TahapJob;
use App\Models\Master\Tahap;
use App\Repositories\Master\TahapRepository;
use App\Support\Response\ApiResponse;
use Illuminate\Http\Request;
use Illuminate\Routing\Controllers\HasMiddleware;
use Illuminate\Routing\Controllers\Middleware;

class TahapController extends Controller implements HasMiddleware
{
    use WithExportImport;

    public function __construct(protected TahapRepository $repository) {}
    ...
    public function store(Request $request)
    {
        ...
        dispatch(new TahapJob($validated['data']));
    ...
    {
        // $model = $this->repository->toArray($tahap);
    ...
    {
        // $model = $this->repository->edit($request->validated(), $tahap);
        // return ApiResponse::data($model);
    }
